  ...
  return (
    ...
    >
      ...
      <Region id="underbody" explode={explode} activeRegion={activeRegion}>
        <rect x="52" y="146" width="300" height="9" rx="4" fill="#585E58" stroke={strokeFor("underbody")} strokeWidth="1.5" />
      ...
      <Region id="body" explode={explode} activeRegion={activeRegion}>
        ...
        />
        <path d="M176 74 L246 74 L268 99 L150 99 Z" fill="#1B2A24" opacity="0.75" />
        <rect x="342" y="112" width="16" height="12" rx="3" fill="#E4DCBE" opacity="0.9" />
      </Region>

      {/* Climate: condenser + blower */}
      <Region id="climate" explode={explode} activeRegion={activeRegion}>
        <rect x="316" y="98" width="12" height="30" rx="2" fill="#8D9A93" stroke={strokeFor("climate")} strokeWidth="1.5" />
        <circle cx="286" cy="92" r="11" fill="#78857E" stroke={strokeFor("climate")} strokeWidth="1.5" />
        <circle cx="286" cy="92" r="4" fill="#22262A" />
      </Region>
      ...
      <Region id="engine" explode={explode} activeRegion={activeRegion}>
        ...
        <rect x="300" y="96" width="10" height="10" rx="2" fill="#8D9A93" />
        <rect x="318" y="96" width="10" height="10" rx="2" fill="#8D9A93" />
      </Region>
      ...
      <Region id="brakes" explode={explode} activeRegion={activeRegion}>
        {[110, 300].map((cx) => (
          <g key={cx}>
            <circle cx={cx} cy="160" r="16" fill="#C8CECC" stroke={strokeFor("brakes")} strokeWidth="1.5" />
            <circle cx={cx} cy="160" r="6" fill="#22262A" />
            <rect x={cx - 22} y="152" width="9" height="16" rx="2" fill="#D97A4A" />
          </g>
        ))}
      </Region>
      ...
      <Region id="wheels" explode={explode} activeRegion={activeRegion}>
        {[110, 300].map((cx) => (
          <g key={cx}>
            <circle cx={cx} cy="160" r="29" fill="#4A4D52" stroke={strokeFor("wheels")} strokeWidth="1.8" />
            <circle cx={cx} cy="160" r="14" fill="#1F5540" />
            <circle cx={cx} cy="160" r="5" fill="#C2C7C7" />
          </g>
        ))}
      </Region>
    </svg>
